...
enforced without exclusions. Portable command integration tests use the production CLI program
in-process for attributable white-box proof, while the compiled live E2E gate remains a separate
black-box check.
