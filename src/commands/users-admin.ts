...
export function addAdminCommands(cmd: Command): void {
  ...
  cmd.command('update-policy <userId>').description('Update user policy')
    .option('-f, --format <format>', 'Output format')
  ...
  cmd.command('update-config <userId>').description('Update user configuration')
    .option('-f, --format <format>', 'Output format')
  ...
  cmd.command('views').description('Get library views for the current user')
    .option('-f, --format <format>', 'Output format')
  ...
  cmd.command('display-prefs <prefsId>').description('Get display preferences for a view (use "usersettings" for general prefs)')
    .option('-f, --format <format>', 'Output format')
