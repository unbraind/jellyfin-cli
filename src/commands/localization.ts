...
/**
 * Builds the localization command tree with validated options and actions.
  ...
  cmd.command('options').description('Get localization options')
    ...
    .action(async (options) => {
      ...
      try {
        ...
        console.log(formatter.formatToon(opts.map((o) => ({ name: o.Name, value: o.Value })), 'localization_options'));
  ...
  cmd.command('countries').description('Get available countries')
    ...
    .action(async (options) => {
      ...
      try {
        ...
        console.log(formatter.formatToon(countries.map((c) => ({
          name: c.Name,
  ...
  cmd.command('cultures').description('Get available cultures/languages')
    ...
    .action(async (options) => {
      ...
      try {
        ...
        console.log(formatter.formatToon(cultures.map((c) => ({
          name: c.Name,
          display_name: c.DisplayName,
  ...
  cmd.command('ratings').description('Get parental rating systems')
    ...
    .action(async (options) => {
      ...
      try {
        ...
        console.log(formatter.formatToon(systems.map((s) => ({
          name: s.Name,
