  ...
  cmd
    ...
    .action(async (name, options) => {
      ...
      try {
        ...
        console.log(formatter.formatToon({ id: result.Id, name: name, created: true }, 'playlist_created'));
      } catch (err) {
  ...
  cmd
    ...
    .action(async (playlistId, entryIds, options) => {
      ...
      try {
        ...
        console.log(formatter.formatMessage('Items removed from playlist'));
      } catch (err) {
        handleError(err, format);
      }
    });
  ...
  cmd
    ...
    .action(async (playlistId, options) => {
      ...
      try {
        ...
        console.log(formatter.formatMessage('Playlist deleted'));
      } catch (err) {
        handleError(err, format);
      }
    });
  ...
  cmd.command('get <playlistId>').description('Get playlist details')
    ...
    .action(async (playlistId, options) => {
      ...
      try {
        ...
        console.log(formatter.formatItem(playlist));
      } catch (err) { handleError(err, format); }
    });
  ...
  cmd.command('update <playlistId>').description('Update playlist name or items')
    ...
    .action(async (playlistId, options) => {
      ...
      try {
        ...
        console.log(formatter.formatMessage('Playlist updated', true));
      } catch (err) { handleError(err, format); }
    });
  ...
  cmd.command('users <playlistId>').description('List users with access to a playlist')
    ...
    .action(async (playlistId, options) => {
      ...
      try {
        ...
        console.log(formatter.formatToon(users.map((u) => ({ user_id: u.UserId, can_edit: u.CanEdit })), 'playlist_users'));
      } catch (err) { handleError(err, format); }
    });
  ...
  cmd.command('share <playlistId> <userId>').description('Grant a user access to a playlist')
    ...
    .action(async (playlistId, userId, options) => {
      ...
      try {
        ...
        console.log(formatter.formatMessage(`User ${userId} granted ${options.canEdit ? 'edit' : 'read'} access`, true));
      } catch (err) { handleError(err, format); }
    });
  ...
  cmd.command('unshare <playlistId> <userId>').description('Remove a user\'s access to a playlist')
    ...
    .action(async (playlistId, userId, options) => {
      ...
      try {
        ...
        console.log(formatter.formatMessage(`User ${userId} access removed`, true));
      } catch (err) { handleError(err, format); }
    });
  ...
  cmd.command('move <playlistId> <itemId> <newIndex>').description('Move item to new position in playlist')
    ...
    .action(async (playlistId, itemId, newIndex, options) => {
      ...
      try {
        ...
        console.log(formatter.formatMessage('Item moved', true));
      } catch (err) { handleError(err, format); }
    });
